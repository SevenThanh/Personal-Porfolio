  ...
  return (
    <div className={`body ${theme ? themeClass : ""}`}>
      <div className="body-content">
        ...
        <h1>Johan Nguyen</h1>
        <p>
          <span className="hi">You want to know me... Choose a side ⬇️</span>
        </p>
        <div>
          <button className="bt1" onClick={() => setTheme("professional")}>
            💼 Professionally
          </button>
          <button className="bt2" onClick={() => setTheme("personal")}>
            🙋 Personally
          </button>
        </div>
      </div>
